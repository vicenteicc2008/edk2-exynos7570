...
#ifndef __EXYNOS_USB_DEVICE_PROTOCOL_H__
#define __EXYNOS_USB_DEVICE_PROTOCOL_H__

#include <IndustryStandard/Usb.h>

extern EFI_GUID gExynosUsbDeviceProtocolGuid;
...
#endif //ifndef __EXYNOS_USB_DEVICE_PROTOCOL_H__