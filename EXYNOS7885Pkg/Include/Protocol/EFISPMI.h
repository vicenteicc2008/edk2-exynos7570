...
/*
  SPMI UEFI typedefs
*/
typedef struct _EFI_EXYNOS_SPMI_PROTOCOL   EFI_EXYNOS_SPMI_PROTOCOL;
/** @endcond */

/*  SPMI UEFI Procotol GUID */
/** @ingroup efi_spmi_protocol */
extern EFI_GUID gExynosSPMIProtocolGuid;
...
typedef EFI_STATUS (*SPMI_READLONG)(
    EFI_EXYNOS_SPMI_PROTOCOL *SpmiProtocolHandle,
    UINT32 uSlaveId,
...
*/
struct EFI_EXYNOS_SPMI_PROTOCOL {
  UINT64                        Revision;
